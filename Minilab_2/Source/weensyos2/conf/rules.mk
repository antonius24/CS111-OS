...
distdir:
	@/bin/rm -rf $(DISTDIR)
	mkdir $(DISTDIR)
	perl mklab.pl 2 0 $(DISTDIR) .bochsrc COPYRIGHT GNUmakefile answers.txt bootstart.S elf.h lib.h lib.c mkbootdisk.c schedos-1.c schedos-2.c schedos-3.c schedos-4.c schedos-app.h schedos-boot.c schedos-int.S schedos-kern.c schedos-kern.h schedos-loader.c schedos-symbols.ld schedos-x86.c schedos.h types.h x86.h x86sync.h conf/rules.mk
