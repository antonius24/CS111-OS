 ...
 * schedos-boot
 *
 *   Set up the schedos kernel, schedos-kern.
 *
 ...
 *
 * DISK LAYOUT
 *  * This program (bootstart.S and schedos-boot.c) is the bootloader.
 *    It should be stored in the disk's sector 0 (the first sector).
 *
 *  * Sectors 1 through 32 hold the image for the schedos kernel and the
 *    schedos application images (as binaries).
 *
