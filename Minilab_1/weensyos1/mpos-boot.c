 ...
 * mpos-boot
 *
 *   Set up the miniprocos kernel, mpos-kern.
 *
 ...
 *
 * DISK LAYOUT
 *  * This program (bootstart.S and mpos-boot.c) is the bootloader.
 *    It should be stored in the disk's sector 0 (the first sector).
 *
 *  * Sectors 1 through 32 hold the image for the mpos kernel
 *    (mpos-kern.c, mpos-x86.c, mpos-int.S).
 *
